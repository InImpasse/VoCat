...
func storedVoWiFiRuntime(runtime store.VoWiFiRuntime) map[string]any {
	...
	return map[string]any{
		...
		"dataplane_diagnostics": vowifi.DataplaneDiagnostics{},
		"sms_diagnostics":       vowifi.SMSDiagnostics{},
		"iccid":                 runtime.ICCID,
		"imsi":                  runtime.IMSI,
...
func liveVoWiFiRuntime(runtime vowifi.State) map[string]any {
	return map[string]any{
		...
		"dataplane_mode":        runtime.DataplaneMode,
		"dataplane_diagnostics": runtime.DataplaneDiagnostics,
		"sms_diagnostics":       runtime.SMSDiagnostics,
		"iccid":                 runtime.ICCID,
		"imsi":                  runtime.IMSI,
		"sim_ready":             runtime.SIMReady,
		"access_ready":          runtime.AccessReady,
